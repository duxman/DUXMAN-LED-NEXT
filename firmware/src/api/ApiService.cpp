...
void ApiService::setupHttpRoutes() {
  ...
  httpServer_.on("/ui/i18n.js", HTTP_GET, [this]() {
    const String data = loadTemplateFromLittleFs("/ui/i18n.js");
    if (data.isEmpty()) { httpServer_.send(404, "application/json", "{\"error\":\"not_found\"}"); return; }
    httpServer_.send(200, "application/javascript", data);
  });
...
<style>
  ...
  .gen-nav>ul{display:flex;justify-content:flex-start;flex:1;list-style:none;margin:0;padding:0;}
...
<main>
  <div class='hero'>
    <svg viewBox="0 0 130 82" xmlns="http://www.w3.org/2000/svg" style="width:300px;max-width:80%;display:block;margin:0 auto 12px;"><defs><linearGradient id="dlg" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#00CFFF"/><stop offset="33%" stop-color="#94FF00"/><stop offset="66%" stop-color="#FFD600"/><stop offset="100%" stop-color="#FF2E2E"/></linearGradient></defs><text x="50%" y="28" text-anchor="middle" font-family="Arial,sans-serif" font-weight="900" font-style="italic" font-size="18" fill="url(#dlg)">duxman-led</text><text x="50%" y="53" text-anchor="middle" font-family="Arial,sans-serif" font-weight="900" font-style="italic" font-size="22" fill="url(#dlg)">next &#xBB;</text><text id="svgVersion" x="50%" y="70" text-anchor="middle" font-family="Consolas,monospace" font-size="8" fill="#0fd0e0" letter-spacing="0.5">...</text></svg>
