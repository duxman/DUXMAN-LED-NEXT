...
Documento actualizado según la implementación actual del firmware `v0.3.5-beta` (Fase 4A-4C, persistencia async, watchdog, catalogo de efectos dinamicos, audio reactivo I2S base y paletas predefinidas).
